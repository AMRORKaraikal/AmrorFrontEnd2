...
const NewSpecimen = () => {
	...
	useEffect(() => {
		async function getCount() {
			const response = await fetch('https://amrorbackend.onrender.com/specimen-id', {
				method: 'POST',
				headers: {
	...
	const subbmitNewSpecimen = async (e) => {
		e.preventDefault()
		const patient_data = {
		...
		try {
			const response = await fetch('https://amrorbackend.onrender.com/new-specimen', {
				method: 'POST',
				headers: {
					'Content-Type': 'application/json',
				},
